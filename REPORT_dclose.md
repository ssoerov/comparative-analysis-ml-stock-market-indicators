...
IMOEX  LSTM_att  9.464280 12.395494 0.866681  0.003496 0.013247
IMOEX    Hybrid  9.556465 12.659486 0.893290  0.007204 0.012704
IMOEX  CatBoost  9.599612 12.753863 0.890983 -0.012896 0.023496
IMOEX LSTM_base  9.746921 12.569763 0.889395 -0.002041 0.015583
IMOEX   SARIMAX 11.260173 14.362702 1.147101 -0.028284 0.031119
IMOEX        RF 11.530023 15.404902 1.225902 -0.007563 0.021737
IMOEX     Naive 11.881167 15.508415 1.000000  0.013969 0.007379
IMOEX    sNaive 16.075167 23.571650 1.550036 -0.018469 0.025087
```
...
```
   Tk    Model     MAE      RMSE     MASE   CumRet    MaxDD
IMOEX LSTM_att 9.46428 12.395494 0.866681 0.003496 0.013247
```
...
IMOEX  LSTM_att    sNaive    MAE -3.024970 0.002487
IMOEX    Hybrid    sNaive    MAE -2.963520 0.003041
...
IMOEX    Hybrid   SARIMAX    MAE -2.217346 0.026599
IMOEX  LSTM_att   SARIMAX    MAE -2.171777 0.029872
IMOEX   SARIMAX    sNaive    MAE -2.059953 0.039403
IMOEX    Hybrid        RF    MAE -2.017544 0.043639
IMOEX        RF    sNaive    MAE -1.900373 0.057384
IMOEX  CatBoost        RF    MAE -1.770374 0.076665
IMOEX  LSTM_att        RF    MAE -1.742035 0.081502
IMOEX  LSTM_att     Naive    MAE -1.702239 0.088710
...
IMOEX    Hybrid     Naive    MAE -1.576765 0.114850
IMOEX     Naive    sNaive    MAE -1.570130 0.116385
IMOEX LSTM_base        RF    MAE -1.464243 0.143127
IMOEX  LSTM_att LSTM_base    MAE -0.642532 0.520528
IMOEX     Naive   SARIMAX    MAE  0.376215 0.706757
IMOEX    Hybrid LSTM_base    MAE -0.317716 0.750700
IMOEX  CatBoost  LSTM_att    MAE  0.308505 0.757698
IMOEX  CatBoost LSTM_base    MAE -0.302853 0.762002
IMOEX        RF   SARIMAX    MAE  0.228712 0.819093
IMOEX    Hybrid  LSTM_att    MAE  0.208129 0.835128
IMOEX     Naive        RF    MAE  0.187532 0.851243
IMOEX  CatBoost    Hybrid    MAE  0.136968 0.891056
IMOEX    Hybrid     Naive   MAPE -2.521118 0.011698
IMOEX  LSTM_att LSTM_base   MAPE -2.509636 0.012086
IMOEX  CatBoost     Naive   MAPE -2.477499 0.013231
IMOEX     Naive        RF   MAPE  2.090501 0.036573
IMOEX    Hybrid        RF   MAPE -2.082196 0.037325
IMOEX    Hybrid LSTM_base   MAPE -2.022994 0.043074
IMOEX  LSTM_att     Naive   MAPE -1.941280 0.052224
IMOEX  CatBoost LSTM_base   MAPE -1.918647 0.055029
IMOEX  CatBoost    Hybrid   MAPE  1.754949 0.079268
IMOEX    Hybrid   SARIMAX   MAPE -1.707501 0.087729
IMOEX    Hybrid  LSTM_att   MAPE -1.707078 0.087808
IMOEX    Hybrid    sNaive   MAPE -1.700387 0.089058
...
IMOEX  CatBoost  LSTM_att   MAPE -1.484955 0.137556
IMOEX  LSTM_att    sNaive   MAPE -1.398037 0.162102
IMOEX  LSTM_att   SARIMAX   MAPE -1.262078 0.206921
IMOEX LSTM_base     Naive   MAPE -1.153477 0.248715
IMOEX  LSTM_att        RF   MAPE  1.146034 0.251781
...
IMOEX    Hybrid     Naive  MDAPE -2.521118 0.011698
IMOEX  LSTM_att LSTM_base  MDAPE -2.509636 0.012086
IMOEX  CatBoost     Naive  MDAPE -2.477499 0.013231
IMOEX     Naive        RF  MDAPE  2.090501 0.036573
IMOEX    Hybrid        RF  MDAPE -2.082196 0.037325
IMOEX    Hybrid LSTM_base  MDAPE -2.022994 0.043074
IMOEX  LSTM_att     Naive  MDAPE -1.941280 0.052224
IMOEX  CatBoost LSTM_base  MDAPE -1.918647 0.055029
IMOEX  CatBoost    Hybrid  MDAPE  1.754949 0.079268
IMOEX    Hybrid   SARIMAX  MDAPE -1.707501 0.087729
IMOEX    Hybrid  LSTM_att  MDAPE -1.707078 0.087808
IMOEX    Hybrid    sNaive  MDAPE -1.700387 0.089058
...
IMOEX  CatBoost  LSTM_att  MDAPE -1.484955 0.137556
IMOEX  LSTM_att    sNaive  MDAPE -1.398037 0.162102
IMOEX  LSTM_att   SARIMAX  MDAPE -1.262078 0.206921
IMOEX LSTM_base     Naive  MDAPE -1.153477 0.248715
IMOEX  LSTM_att        RF  MDAPE  1.146034 0.251781
...
IMOEX  LSTM_att   SARIMAX   RMSE -2.543190 0.010985
IMOEX    Hybrid   SARIMAX   RMSE -2.483609 0.013006
IMOEX  CatBoost   SARIMAX   RMSE -2.430642 0.015072
IMOEX  LSTM_att     Naive   RMSE -1.973285 0.048463
IMOEX    Hybrid        RF   RMSE -1.961136 0.049863
IMOEX  LSTM_att        RF   RMSE -1.920118 0.054843
IMOEX  LSTM_att    sNaive   RMSE -1.910107 0.056119
IMOEX    Hybrid     Naive   RMSE -1.898031 0.057692
IMOEX LSTM_base     Naive   RMSE -1.880185 0.060083
IMOEX LSTM_base   SARIMAX   RMSE -1.879107 0.060230
IMOEX    Hybrid    sNaive   RMSE -1.875750 0.060690
...
IMOEX  CatBoost  LSTM_att   RMSE  0.814648 0.415274
IMOEX     Naive   SARIMAX   RMSE  0.783149 0.433540
IMOEX        RF   SARIMAX   RMSE  0.771147 0.440620
IMOEX  LSTM_att LSTM_base   RMSE -0.734936 0.462378
IMOEX    Hybrid  LSTM_att   RMSE  0.546327 0.584841
IMOEX  CatBoost    Hybrid   RMSE  0.399481 0.689539
IMOEX    Hybrid LSTM_base   RMSE -0.324238 0.745758
IMOEX  CatBoost LSTM_base   RMSE -0.174411 0.861542
IMOEX     Naive        RF   RMSE  0.109567 0.912752
IMOEX    Hybrid    sNaive  SMAPE  3.032424 0.002426
IMOEX    Hybrid     Naive  SMAPE  2.947649 0.003202
IMOEX  CatBoost    sNaive  SMAPE  2.478651 0.013188
IMOEX  CatBoost     Naive  SMAPE  2.469728 0.013522
IMOEX    Hybrid LSTM_base  SMAPE  2.420770 0.015488
...
IMOEX    Hybrid   SARIMAX  SMAPE  2.080414 0.037488
IMOEX    Hybrid  LSTM_att  SMAPE  1.899122 0.057548
IMOEX  CatBoost   SARIMAX  SMAPE  1.581957 0.113659
IMOEX LSTM_base        RF  SMAPE -1.478204 0.139353
IMOEX  LSTM_att     Naive  SMAPE  1.293429 0.195863
IMOEX  CatBoost  LSTM_att  SMAPE  1.191274 0.233546
IMOEX  LSTM_att    sNaive  SMAPE  1.133363 0.257062
IMOEX   SARIMAX    sNaive  SMAPE  1.089734 0.275830
IMOEX    Hybrid        RF  SMAPE  1.066394 0.286245
IMOEX        RF   SARIMAX  SMAPE  1.032274 0.301944
IMOEX     Naive   SARIMAX  SMAPE -1.026802 0.304514
IMOEX  CatBoost    Hybrid  SMAPE -1.015554 0.309842
IMOEX  LSTM_att        RF  SMAPE -0.858043 0.390869
IMOEX  LSTM_att LSTM_base  SMAPE  0.778214 0.436443
...
IMOEX  LSTM_att   SARIMAX  SMAPE  0.178608 0.858245
IMOEX     Naive    sNaive  SMAPE -0.040408 0.967768
IMOEX    Hybrid     Naive   WAPE -2.521118 0.011698
IMOEX  LSTM_att LSTM_base   WAPE -2.509636 0.012086
IMOEX  CatBoost     Naive   WAPE -2.477499 0.013231
IMOEX     Naive        RF   WAPE  2.090501 0.036573
IMOEX    Hybrid        RF   WAPE -2.082196 0.037325
IMOEX    Hybrid LSTM_base   WAPE -2.022994 0.043074
IMOEX  LSTM_att     Naive   WAPE -1.941280 0.052224
IMOEX  CatBoost LSTM_base   WAPE -1.918647 0.055029
IMOEX  CatBoost    Hybrid   WAPE  1.754949 0.079268
IMOEX    Hybrid   SARIMAX   WAPE -1.707501 0.087729
IMOEX    Hybrid  LSTM_att   WAPE -1.707078 0.087808
IMOEX    Hybrid    sNaive   WAPE -1.700387 0.089058
...
IMOEX  CatBoost  LSTM_att   WAPE -1.484955 0.137556
IMOEX  LSTM_att    sNaive   WAPE -1.398037 0.162102
IMOEX  LSTM_att   SARIMAX   WAPE -1.262078 0.206921
IMOEX LSTM_base     Naive   WAPE -1.153477 0.248715
IMOEX  LSTM_att        RF   WAPE  1.146034 0.251781
